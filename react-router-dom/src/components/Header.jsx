    ...
    <div class='flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full'>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/feature_one"} href='javascript:void(0)'
            class='lg:hover:text-[#007bff] text-gray-800 block text-[15px]'>Feature</NavLink>
          </li>
          <li class='max-lg:border-b max-lg:py-3 px-3'><NavLink to={"/blogs"} href='javascript:void(0)'
